        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="TextBox1" ErrorMessage=" catogoryname Required"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="style3">
            ...
            <td class="style3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="TextBox2" ErrorMessage="subcatogory name requrd"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
