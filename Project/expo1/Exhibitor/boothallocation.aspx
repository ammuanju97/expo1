        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="TextBox1" ErrorMessage="enter expo name"></asp:RequiredFieldValidator>
                <asp:RangeValidator ID="RangeValidator1" runat="server" 
                    ControlToValidate="TextBox1" ErrorMessage="enter name" MaximumValue="z" 
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RangeValidator ID="RangeValidator2" runat="server" 
                    ControlToValidate="booth" ErrorMessage="enter number" MaximumValue="100" 
