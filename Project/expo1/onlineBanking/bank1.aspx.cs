    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (resultRow1.Rows.Count > 0)
            {
                ...
                cs.execute("insert into tbl_transaction (fromAccountNo,toAccountNo,amount,remarks) values ((select distinct accountNo from tbl_accountDetails where cardNo = '" + cardNo + "'),'" + paymentToaccountNo + "','" + amount + "','" + remarkss + "')");
