...
&nbsp;</td>
    ...
    <tr>
        ...
        <marquee direction="up" scrolldelay="600">
            <asp:DataList ID="DataList1" runat="server" Width="400px" CellPadding="4" 
                DataSourceID="SqlDataSource2" ForeColor="#333333" style="text-align: center">
...
<br />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ConnectionString="<%$ ConnectionStrings:expomanagementConnectionString45 %>" 
                SelectCommand="SELECT [details] FROM [sendnotify]"></asp:SqlDataSource></marquee>
        </td>
    </tr>
    <tr>
        <td colspan="2">
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:expomanagementConnectionString48 %>" DeleteCommand="DELETE FROM [userreg] WHERE [userId] = @userId" InsertCommand="INSERT INTO [userreg] ([logid], [name], [age], [housename], [country], [state], [district], [place], [mobileno], [emailid]) VALUES (@logid, @name, @age, @housename, @country, @state, @district, @place, @mobileno, @emailid)" SelectCommand="SELECT * FROM [userreg] WHERE ([userId] = @userId)" UpdateCommand="UPDATE [userreg] SET [logid] = @logid, [name] = @name, [age] = @age, [housename] = @housename, [country] = @country, [state] = @state, [district] = @district, [place] = @place, [mobileno] = @mobileno, [emailid] = @emailid WHERE [userId] = @userId">
                <DeleteParameters>
            ...
            <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT * FROM [userreg]" 
