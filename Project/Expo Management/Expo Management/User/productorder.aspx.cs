...
public partial class User_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            da.dropdown("select distinct companyregist.companyname,companyregist.*,invitecompany.* from companyregist inner join invitecompany on invitecompany.companyId=companyregist.companyId where invitecompany.status='accepted' and invitecompany.expoId='" + Request.QueryString["id"] + "'", ddlcom, "companyname", "companyId");
        }
