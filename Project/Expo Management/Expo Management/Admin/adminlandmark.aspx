    ...
    background-color: sandybrown;" onclick="Button2_Click" Text="Edit" />
        ...
        <asp:View ID="View2" runat="server">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                DataKeyNames="id" DataSourceID="SqlDataSource1" Width="198px" 
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                DeleteCommand="DELETE FROM [adminland] WHERE [id] = @id" 
                ...
                UpdateCommand="UPDATE [adminland] SET [country] = @country, [state] = @state, [district] = @district, [place] = @place WHERE [id] = @id">
                <DeleteParameters>
