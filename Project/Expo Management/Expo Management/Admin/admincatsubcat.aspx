        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="TextBox1" ErrorMessage="enter category name"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="TextBox2" ErrorMessage="enter subcategory name"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
       ...
       <asp:View ID="View2" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [admincat] WHERE [id] = @id" 
                    ...
                    UpdateCommand="UPDATE [admincat] SET [categoryname] = @categoryname, [subcategoryname] = @subcategoryname WHERE [id] = @id">
                    <DeleteParameters>
