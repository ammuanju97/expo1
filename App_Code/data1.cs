...
public class data1
{
    SqlConnection con = new SqlConnection(@"Data Source=USER\SQLEXPRESS;Initial Catalog=dreamzBank;Integrated Security=True");
    SqlCommand cmd;
    SqlDataReader dr;
    SqlDataAdapter da;
    public void opencon()
    ...
    public void gridview(string sql, GridView gv)
    {
        ...
        public void mail(string to, string sub, string body)
        {
            ...
            mail.From = new MailAddress("sitnahari@gmail.com");
            mail.To.Add(to);
            mail.Subject = sub;
            mail.Body=body;
            SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("sitnahari@gmail.com","sitnahari123");
