...
public partial class company_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dr = d.dataread("select sugges.*,userreg.* from sugges inner join userreg on sugges.userId=userreg.userId where status='pending' and sugges.companyid='" + Session["companyId"] + "'");
        if(!dr.Read())
        {
            Label10.Text = "Sorry...Nothing to Show Suggestions";
        }
    }
