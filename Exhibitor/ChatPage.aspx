...
<body ng-app style="background-color:#8BB7F1">
    ...
    <div id = "container" style = " text-align:center">
        ...
        <span style="height:30px;background-color:blue;float:right;text-align:right;width:350px">
            ...
            <table width = "100%">
                <tr ng-repeat = "msg in globalChat">
                    <td>
                        <asp:TextBox ID="TextBox2" runat="server"  CssClass="textbox" Height="255px" style="margin-left: 49px" TextMode="MultiLine" Width="220px"></asp:TextBox>
        ...
        <div>
            <asp:TextBox ID="TextBox1" runat="server"  CssClass="textbox" AutoPostBack="True" Height="50px" OnTextChanged="TextBox1_TextChanged" TextMode="MultiLine" Width="256px"></asp:TextBox>
&nbsp;</div>
    </div>
    </div>
    ...
    background-color: sandybrown;" Text="Back to Home" Height="33px" 
